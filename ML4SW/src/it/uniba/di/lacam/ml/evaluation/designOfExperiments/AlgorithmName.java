...
public enum AlgorithmName {
	...
	public String toString(){
		if (this.compareTo(TerminologicalDecisionTree)==0)
			...
			return "it.uniba.di.lacam.ml.classifiers.TerminologicalDecisionTreeInducer";
		
		else if (this.compareTo(DSTTerminologicalDecisionTree)==0)
			return  "it.uniba.di.lacam.ml.classifiers.DSTTerminologicalDecisionTreeInducer";
		
		else if (this.compareTo(TerminologicalRandomForests)==0)
			return  "it.uniba.di.lacam.ml.classifiers.TerminologicalRandomForestsInducer";
		
		else if (this.compareTo(DSTTerminologicalRandomForests)==0)
			return "it.uniba.di.lacam.ml.classifiers.EvidentialTerminologicalRandomForestInducer";
	...
	public static AlgorithmName getClassifier(String name){
		...
		if (name.compareTo("it.uniba.di.lacam.ml.classifiers.TerminologicalDecisionTreeInducer")==0)
			return TerminologicalDecisionTree;
		else if (name.compareTo("it.uniba.di.lacam.ml.classifiers.TerminologicalRandomForestsInducer")==0)
			return TerminologicalRandomForests;
		else if (name.compareTo("it.uniba.di.lacam.ml.classifiers.DSTTerminologicalDecisionTreeInducer")==0)
