package it.uniba.di.lacam.ml.classifiers.trees.models;
...
public class DLTree extends AbstractTree {
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#getMatch()
	 */
	@Override
	public int getMatch() {
		return match;
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#setMatch(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#getOmission()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#setOmission(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#getCommission()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#setCommission(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#getInduction()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.uniba.di.lacam.ml.classifiers.trees.models.AbstractTree#setInduction(int)
	 */
	@Override
